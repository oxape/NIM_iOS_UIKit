...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        [_voiceBtn setImage:[UIImage imageNamed:@"session-voice-media"] forState:UIControlStateNormal];
        [_voiceBtn setImage:[UIImage imageNamed:@"session-voice-media"] forState:UIControlStateHighlighted];
        [_voiceBtn setContentEdgeInsets:UIEdgeInsetsMake(8, 16, 8, 16)];
        [_voiceBtn sizeToFit];
